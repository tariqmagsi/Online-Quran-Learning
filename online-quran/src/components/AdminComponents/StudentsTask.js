...
class TeachersTask extends React.Component {
  ...
  searchE = () => {
    ...
    fetch(
      "/searchwishlist?isEnrolledByStudent=true&&isEnrolled=true&&isTeacher=false&&name=" +
        nameInput +
        "&&email=" +
        emailInput +
        "&&contact=" +
  ...
  searchNE = () => {
    ...
    fetch(
      "/searchwishlist?isEnrolledByStudent=true&&isEnrolled=false&&isTeacher=false&&name=" +
        nameInputN +
        "&&email=" +
        emailInputN +
        "&&contact=" +
  ...
  fetchDataE = skip => {
    fetch(
      "/wishlists?isEnrolledByStudent=true&&isEnrolled=true&&isTeacher=false&&limit=20&&skip=" +
        skip
    )
      .then(res => res.json())
      .then(json => {
  ...
  fetchDataNE = skip => {
    fetch(
      "/wishlists?isEnrolledByStudent=true&&isEnrolled=false&&isTeacher=false&&limit=20&&skip=" +
        skip
    )
      .then(res => res.json())
      .then(json => {
      ...
      <div id="enroll container">
        <div style={{ marginTop: "40px" }}>
          <div className="Homepage-heading">
            Pending Enrollment Students With Courses List
          </div>
        ...
        <div className="Homepage-heading">
          Enrollment Confirmed Students With Courses List
        </div>
        <div style={{ overflowX: "auto" }}>
          <table className="table table-dark table-hover bg-black text-white table-striped">
            <thead className="table table-dark">
